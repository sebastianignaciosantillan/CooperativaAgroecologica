...
public class NuevoProductor extends javax.swing.JFrame {
        //llamo a la control desde la interfaz grafica (para aqui)
        Controladora control = null;
    
    public NuevoProductor() {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Carga de datos de productor");
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        Productor productor = new Productor(nombre, puesto, telefono, localidad, tipo, fechaIngreso);
        
        control.crearProductor(productor);

        
        JOptionPane.showMessageDialog(null, "Productor registrado con éxito");
        limpiarPantalla();
